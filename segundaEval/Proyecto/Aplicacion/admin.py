...
class UserAdmin(admin.ModelAdmin):
    list_display = ('username', 'correo_electronico', 'rol', 'created_at')
    list_filter = ('rol', 'created_at')
    search_fields = ('username', 'correo_electronico')
...
class ReservaAdmin(admin.ModelAdmin):
    ...
    search_fields = ('usuario_username', 'evento_titulo')
...
class ComentarioAdmin(admin.ModelAdmin):
    ...
    search_fields = ('usuario_username', 'evento_titulo', 'texto')
